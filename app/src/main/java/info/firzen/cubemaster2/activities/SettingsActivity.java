...
public class SettingsActivity extends PreferenceActivity {
	...
	protected void onPostCreate(Bundle savedInstanceState) {
		...
		Preference myPref = (Preference) findPreference("p_reset");
		
		if(myPref != null) {
			myPref.setOnPreferenceClickListener(new OnPreferenceClickListener() {
				public boolean onPreferenceClick(Preference preference) {
					Useful.showQuestion(getString(R.string.erase_settings)
							+ "\n" + getString(R.string.erase_settings_proceed),
							SettingsActivity.this, new Action() {
								public void run() {
									PreferenceManager.getDefaultSharedPreferences(
											SettingsActivity.this).edit().clear()
											.commit();
									Useful.refreshBackendStickers();
									Useful.showToast(getString(R.string.settings_reset_done),
