/**
 * Copied from http://stackoverflow.com/questions/6980906/android-color-picker
 */
...
public class ColorPickerDialog extends Dialog {
	...
	public ColorPickerDialog(Context context, String key, int initialColor,
			int defaultColor) {
		super(context);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		picker = new ColorPickerView(getContext(), l, mInitialColor,
				mDefaultColor);
